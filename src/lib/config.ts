...
const storyMax = parseThreshold(PUBLIC_STORY_MAX_SECONDS, 90);
const reelMax = parseThreshold(PUBLIC_REEL_MAX_SECONDS, 250);
// Enforce stories < reels; otherwise both fall back to defaults.
const valid = reelMax > storyMax;
export const STORY_MAX_SECONDS = valid ? storyMax : 90;
export const REEL_MAX_SECONDS = valid ? reelMax : 250;
